...
struct FriendListView: View {
    ...
    var body: some View {
        VStack {
            ...
            HeaderForFriendListView(viewMode: $viewMode, isGridView: $isGridView, isDdaySort: $isDdaySort, friends: friends)
                .padding(.bottom, 18)
            ...
            if isGridView {
                GridForFriendListView(friends: friends)
            } else {
                ListForFriendListView(friends: friends)
            }
        }
